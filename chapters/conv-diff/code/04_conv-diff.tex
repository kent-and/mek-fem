...
\begin{figure}
\begin{center}
\includegraphics[width=6cm]{../pics/conv-diff.png}
\includegraphics[width=6cm]{../pics/conv-diff-hr.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=6cm]{../pics/conv-diff-stab.png}
\includegraphics[width=6cm]{../pics/conv-diff-hr-stab.png}
\caption{Solution of the convection diffusion problem obtained with 10 and 100 elements
